    ...
    return (
        <div className="login-container flex items-center justify-center min-h-screen" >
            <div className="login-card shadow-lg p-8 rounded-lg " style={{ backgroundColor: 'rgb(243,232,255)' }}>
                <h2 className="text-4xl font-bold mb-6 text-center" style={{ color: 'rgb(126,34,206)' }}>Sign Up</h2>
                ...
                <p className="text-center mt-4">
                    Already have an account? <Link to="/login" className="font-bold text-indigo-600">Login!</Link>
                </p>
            </div>
        </div>
    );
