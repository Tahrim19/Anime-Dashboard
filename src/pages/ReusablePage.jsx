...
// const ReusablePage = ({handleClick}) => {
...
//   const totalAnimeCount = 500; // total anime count fetched
...
const ReusablePage = ({ handleClick }) => {
    ...
    if (!Array.isArray(list)) {
        return <div className="text-center text-red-500">No Manga found</div>;
    }

    const totalAnimeCount = list.length; // Update based on the actual count from API
    const itemsPerPage = 25;
    const totalPages = Math.ceil(totalAnimeCount / itemsPerPage);
